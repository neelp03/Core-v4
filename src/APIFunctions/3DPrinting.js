...
export async function submit3DPrintRequest(printRequest) {
  ...
  await axios
    .post(MAIN_API_URL + '/api/3DPrintingForm/submit', {
      name,
      color,
      comment,
      contact,
...
export async function getAll3DPrintRequests() {
  let status = new ApiResponse();
  await axios
    .post(MAIN_API_URL + '/api/3DPrintingForm/GetForm')
    .then(result => {
...
export async function delete3DPrintRequest(requestToDelete, token) {
  ...
  await axios
    .post(MAIN_API_URL + '/api/3DPrintingForm/delete', {
      token,
      date,
      email
    })
...
export async function update3DPrintRequestProgress(requestToUpdate, token) {
  ...
  await axios
    .post(MAIN_API_URL + '/api/3DPrintingForm/edit', {
      date,
      email,
      progress,
      token
